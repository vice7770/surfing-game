...
| **P3** (P3a ✓) | Emergent breaking. **P3a done** ([record](../superpowers/plans/2026-09-25-p3a-emergent-breaking.md)): a breaking indicator (Kennedy test plus a stage 1 depth-limited bore criterion, because the Kennedy rise rate is resolution dependent in the shallow-water solver), whitewater, the Iribarren breaker type, measured peel angle with close-out and skill rating, and local wind (chop and a ±20 % onset shift). The surf zone needs cells of 1 m or finer. P3b: storm mode, a mass-conserving Iribarren lip in the physical mode, and rideability statistics. | Breaking-depth and Miche tests (stage 1 records its known bias); lip mass balance; per-spot rideability report generated. |
