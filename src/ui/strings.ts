...
export const EN = {
  ...
  'settings.balanceMeter': 'Balance meter',
  'settings.balanceMeter.practice': 'Practice',
  'settings.balanceMeter.always': 'Always',
  'settings.balanceMeter.never': 'Never',
  ...
  'action.trimBack': 'Trim back',
  'action.crouch': 'Crouch',
  'action.hand': 'Hand in the face',
